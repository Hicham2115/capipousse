  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-[#f8f8f6] px-5 py-10 sm:px-10 lg:px-16 lg:py-12">
      ...
      <div className="relative mx-auto grid max-w-[1600px] items-start gap-8 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        ...
        <div className="min-w-0 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm sm:p-7">
      ...
      <div className="relative mx-auto mt-8 grid max-w-[1600px] items-center gap-6 rounded-xl border border-neutral-200 bg-white px-6 py-5 lg:grid-cols-[1.2fr_1fr_auto]">
